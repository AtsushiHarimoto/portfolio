  ...
  en: {
    ...
    career: {
      ...
      items: [
        {
          period: '2025.8 — Present',
          role: 'Bridge SE / AI Architect',
          domain: 'Enterprise IT & AI Systems',
          description:
            'Serving as a Bridge SE, leading technical coordination and requirement alignment with offshore teams. Concurrently adopting "Vibe Coding" AI-assisted workflows to deploy production-ready subsystems for the Moyin AI platform.',
          tech: ['TypeScript', 'React', 'Python', 'FastAPI', 'Claude', 'Copilot', 'Docker', 'GitHub Actions'],
          achievements: [
            'Mitigated project delivery risks through cross-border technical communication',
            'Achieved a 10x productivity boost by leveraging AI coding agents (Claude/Copilot) for full-stack implementation',
            'Architected and deployed a multi-provider LLM API gateway and FastMCP server from scratch',
          ],
        },
        {
          period: '2024.12 — 2025.7',
          role: 'Independent Developer & AI Architect',
          domain: 'AI-Driven Content Platform',
          description:
            'Dedicated an 8-month full-time sabbatical to deep dive into LLMs and Generative AI. Architected "Moyin Factory," a comprehensive microservice platform comprising 14 sub-systems, demonstrating exceptional system-level formulation and resource integration capabilities.',
          tech: ['Python', 'FastAPI', 'Node.js', 'Model Context Protocol', 'Ollama', 'ComfyUI', 'LLM', 'AI Agents'],
          achievements: [
            'Architectural Vision: Authored 40+ comprehensive design documents mapping out 4 ecosystems (Central OS, Generative Engines, Infra Gateway, VisNovel Game)',
            'Ecosystem Integration: Built a seamless AI collaboration foundation by integrating open-source tech stacks like Ollama, MCP, and FastAPI',
          ],
        },
        {
          period: '2024.1 — 2024.11',
          role: 'Systems Engineer',
          domain: 'FinTech',
          description:
            'Developed a foreign currency application for a major banking client. Balanced extreme security constraints with efficient business logic delivery by combining Web, Hybrid, and Native technologies.',
          tech: ['JavaScript', 'Java', 'Swift', 'Kotlin', 'Objective-C', 'REST API'],
          achievements: [
            'Optimized API design and data flow based on strict business scenarios, clearing major performance bottlenecks',
            'Ensured stable and high-quality deliveries sprint after sprint under an Agile framework',
          ],
        },
        {
          period: '2021.10 — 2023.12',
          ...
          domain: 'Aviation & IoT',
          description:
            'Led the architecture of a real-time helicopter flight monitoring system, transforming complex aviation tracking needs into a reliable, integrated IoT visualization solution.',
          tech: ['JavaScript', 'TypeScript', 'Java', 'Swift', 'Kotlin', 'Map API', 'CI/CD'],
          achievements: [
            'Cut critical telemetry data latency by 50% (from 400ms to 200ms) by optimizing core data synchronization',
            'Strengthened team-wide engineering velocity by introducing CI/CD and strict code review standards',
          ],
        },
        {
          period: '2014.10 — 2021.9',
          ...
          description:
            'Progressed from full-stack developer to Team Lead, taking charge of architecture, tech selection, and end-to-end lifecycle management across EC, CRM, and ERP domains.',
          tech: ['Swift', 'Objective-C', 'JavaScript', 'Vue.js', 'Java', 'Python', 'Uniapp'],
          achievements: [
            'Designed a universal iOS/JS communication framework, massively boosting module reusability across enterprise projects',
            'Guided department-wide frontend technical strategy, defining coding standards, architectures, and review practices',
          ],
        },
        {
          period: '2009.9 — 2014.9',
          role: 'Mobile Developer → Team Leader',
          domain: 'Smart Home & IoT',
          description:
            'During the dawn of the IoT era, developed mobile companion apps linking edge hardware devices to cloud services. Promoted to Team Lead for exceptional UI/UX execution and communication.',
          tech: ['Objective-C', 'Java', 'iOS', 'Android'],
          achievements: [
            'Shipped multiple IoT companion applications for a diverse smart home ecosystem',
            'Overcame protocol and firmware-level constraints to establish a seamless hardware-software interaction loop',
          ],
        },
      ],
    },
      ...
      items: [
        {
          period: '2025.8 — 現在',
          role: 'BSE / AIアーキテクト',
          domain: 'エンタープライズIT・AI基盤',
          description:
            '大手企業（富士フイルム）にてBSEとしてオフショア（上海）との技術調整・要件定義を主導し、プロジェクトの円滑なデリバリーを担保。並行して「Vibe Coding」を実践し、本番環境レベルの「Moyin」AIプラットフォームを個人で設計・運用。',
          tech: ['TypeScript', 'React', 'Python', 'FastAPI', 'Claude', 'Copilot', 'Docker', 'GitHub Actions'],
          achievements: [
            '国境を越えた技術コミュニケーションと要件折衝を行い、開発リスクと認識のズレを最小化',
            'ClaudeやCopilot等のAIツールを高度に統合活用し、フルスタック開発の生産性を劇的に向上',
            'マルチプロバイダLLMゲートウェイおよびMCPサーバーのアーキテクチャ設計・実装をゼロから完遂',
          ],
        },
        {
          period: '2024.12 — 2025.7',
          role: '独立系デベロッパー & AIアーキテクト',
          domain: 'AI駆動コンテンツプラットフォーム（Sabbatical）',
          description:
            'システム構築とAI技術の探求に専念するためのフルタイム研究期間（サバティカル）。14のマイクロサービスからなる大規模AIプラットフォーム「Moyin Factory」をゼロから設計し、強力なシステム統合とアーキテクチャ設計力を実証。',
          tech: ['Python', 'FastAPI', 'Node.js', 'Model Context Protocol', 'Ollama', 'ComfyUI', 'LLM', 'AI Agents'],
          achievements: [
            'マクロ設計力：OS層、基盤層、生成層（ComfyUI/TTS）、応用層（ゲームエンジン）を統合する40件超の設計文書を策定',
            '技術統合力：MCPやFastAPIを用い、Ollama等の最先端オープンソース技術群をシームレスに連携させる通信仕様を確立',
          ],
        },
        {
          period: '2024.1 — 2024.11',
          role: 'システムエンジニア',
          domain: '金融（FinTech / 銀行システム）',
          description:
            '金融機関向けの大規模外貨預金アプリを開発。極めて高いセキュリティ要件と高頻度トランザクション下において、業務要件を正確に把握し、Web/Hybrid/Nativeを適材適所で組み合わせてビジネス価値を最大化。',
          tech: ['JavaScript', 'Java', 'Swift', 'Kotlin', 'Objective-C', 'REST API'],
          achievements: [
            '業務フローに即したAPI設計とデータ転送制御の最適化により、システムのパフォーマンスボトルネックを解消',
            'アジャイル開発のスプリントごとの、安定的で高品質なビジネス機能デリバリーを担保',
          ],
        },
        {
          period: '2021.10 — 2023.12',
          role: 'アプリ開発エンジニア / テックリード',
          domain: '航空・IoT',
          description:
            'ヘリコプター運航のリアルタイム監視システムのアーキテクチャ設計・開発。複雑な航空業務要件をクリアなシステム構成へと転換し、IoTセンサーデータとMap APIを統合したリアルタイム可視化ソリューションを提供。',
          tech: ['JavaScript', 'TypeScript', 'Java', 'Swift', 'Kotlin', 'Map API', 'CI/CD'],
          achievements: [
            'リアルタイム同期のデータ通信最適化を実施し、遅延を400msから200msへと半減',
            'チームへCI/CDとコードレビュー基準を導入し、組織のエンジニアリングデリバリー水準を底上げ',
          ],
        },
        {
          period: '2014.10 — 2021.9',
          role: 'チームリーダー / シニアエンジニア',
          domain: 'エンタープライズシステム（EC / CRM / ERP）',
          description:
            'フルスタック開発から部門技術管理・チームリーダーへ昇格。フロントエンドとモバイルアプリ（iOS/Android）を横断する多数のエンタープライズ製品にて、技術選定からライフサイクル全体をマネジメント。',
          tech: ['Swift', 'Objective-C', 'JavaScript', 'Vue.js', 'Java', 'Python', 'Uniapp'],
          achievements: [
            'エンタープライズ領域における汎用的なiOS/JS通信フレームワークを設計し、複数プロジェクト間でのモジュール再利用性を大幅に向上',
            '部門全体のフロントエンド技術戦略、コーディング規約、アーキテクチャ標準の策定を主導',
          ],
        },
        {
          period: '2009.9 — 2014.9',
          role: 'モバイル開発エンジニア → チームリーダー',
          domain: 'スマートホーム・IoT',
          description:
            'IoT黎明期においてハードウェアとクラウドを繋ぐモバイルアプリケーションを開発。ハードウェア制約と極上のUXのバランスを両立するソリューション提案力が高く評価され、リーダーへ抜擢。',
          tech: ['Objective-C', 'Java', 'iOS', 'Android'],
          achievements: [
            'スマートホームエコシステムに対応した多数のIoTハードウェア連携アプリをリリース',
            'クロスプラットフォームプロトコルやファームウェアとの通信の壁を乗り越え、シームレスな操作体験を確立',
          ],
        },
      ],
    },
  ...
  'zh-tw': {
    ...
    career: {
      ...
      items: [
        {
          period: '2025.8 — 現職',
          role: 'BSE 橋樑工程師 / AI 架構師',
          domain: '企業級 IT 與 AI 基盤',
          description:
            '於大型企業（富士軟片）擔任 BSE，主導與離岸團隊的技術協調與需求對接，確保跨國專案的順利交付。同時，深度實踐「Vibe Coding」AI 輔助開發工作流，獨立部署具備生產環境水準的「Moyin」AI 平台子系統。',
          tech: ['TypeScript', 'React', 'Python', 'FastAPI', 'Claude', 'Copilot', 'Docker', 'GitHub Actions'],
          achievements: [
            '負責跨國技術溝通與需求規格對齊，有效降低開發落差與交付風險',
            '熟練整合 Claude Code、GitHub Copilot 等 AI 工具，達成全端開發效率的十倍躍升',
            '從零架構設計並實作多供應商 LLM API 網關與 FastMCP 伺服器',
          ],
        },
        {
          period: '2024.12 — 2025.7',
          role: '獨立開發者 & AI 架構師 (Sabbatical)',
          domain: 'AI 驅動內容平台 (Side Project)',
          description:
            '主動安排 8 個月的全職技術探索期，專注於 LLM 與生成式 AI 領域的深度實踐。從零架構由 14 個微服務子系統構成的巨型「Moyin Factory」平台，展現卓越的系統拆解與資源整合能力。',
          tech: ['Python', 'FastAPI', 'Node.js', 'Model Context Protocol', 'Ollama', 'ComfyUI', 'LLM', 'AI Agents'],
          achievements: [
            '架構藍圖規劃：完成超過 40 篇核心架構文件，統籌包含作業系統層、驅動層(ComfyUI/TTS)、基建層(Gateway/MCP)與應用層(視覺小說引擎)四大板塊',
            '開源生態整合：串接整合尖端技術 (如 Ollama, Model Context Protocol, FastAPI)，確立系統模組間的通訊規格與高擴展性底座',
          ],
        },
        {
          period: '2024.1 — 2024.11',
          role: '系統工程師',
          domain: '金融科技 (FinTech / 銀行系統)',
          description:
            '參與大型銀行外幣存款行動端 APP 開發。在嚴密資安標準與高頻率業務邏輯下，準確捕捉業務核心需求，靈活混用 Web、Hybrid 與 Native 開發模式，確保持續且穩定的商業交付。',
          tech: ['JavaScript', 'Java', 'Swift', 'Kotlin', 'Objective-C', 'REST API'],
          achievements: [
            '基於業務場景優化 API 設計與資料傳輸控制，解決系統效能瓶頸',
            '確保敏捷式開發 (Agile) 節奏，使每個 Sprint 的業務功能按時、高質量落地',
          ],
        },
        {
          period: '2021.10 — 2023.12',
          role: '應用開發工程師 / 技術負責人',
          domain: '航空與物聯網 (Aviation & IoT)',
          description:
            '負責直升機即時飛航監控系統的架構設計。統籌軟硬體與感測器數據結合，將高難度航空追蹤業務轉化為可靠的視覺化解決方案。',
          tech: ['JavaScript', 'TypeScript', 'Java', 'Swift', 'Kotlin', 'Map API', 'CI/CD'],
          achievements: [
            '攻克即時同步的效能痛點，將核心數據傳輸延遲由 400ms 成功縮減半至 200ms',
            '推動團隊導入 CI/CD 與代碼審查標準，顯著提升團隊整體的工程技術水準',
          ],
        },
        {
          period: '2014.10 — 2021.9',
          role: '團隊 Leader / 資深工程師',
          domain: '企業系統 (EC / CRM / ERP)',
          description:
            '由全端開發晉升為部門技術管理與團隊 Leader。主導多項大型企業級產品，跨越前/後端與行動端，負責從技術選型、需求釐清到團隊建構的全生命週期管理。',
          tech: ['Swift', 'Objective-C', 'JavaScript', 'Vue.js', 'Java', 'Python', 'Uniapp'],
          achievements: [
            '設計並實現企業內部通用的 iOS/JS 通信框架，大幅提升跨專案的模組複用率',
            '帶領部門制訂前端技術標準、代碼規範與技術演進藍圖，承擔跨部門資源溝通',
          ],
        },
        {
          period: '2009.9 — 2014.9',
          role: '行動端工程師 → 團隊 Leader',
          domain: '智慧家庭與物聯網 (Smart Home)',
          description:
            '在 IoT 發展初期，負責開發連結硬體設備與雲端服務的行動端應用。擅長在硬體規格限制與極致的用戶體驗之間取得平衡，憑藉出色的解決方案交付能力被拔擢為團隊 Leader。',
          tech: ['Objective-C', 'Java', 'iOS', 'Android'],
          achievements: [
            '規劃並上線多款串聯智慧家庭硬體設備的 IoT 伴侶應用程式 (Companion App)',
            '克服跨端協定與硬體底層韌體的通訊瓶頸，建立穩定流暢的實體操作體驗',
          ],
        },
      ],
    },
