  ...
  gamepad: (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
        d="M14.25 6.087c0-.355.186-.676.401-.959.221-.29.349-.634.349-1.003 0-1.036-1.007-1.875-2.25-1.875s-2.25.84-2.25 1.875c0 .369.128.713.349 1.003.215.283.401.604.401.959v0a.64.64 0 01-.657.643 48.491 48.491 0 01-4.163-.3c-1.588-.182-3.18.465-4.11 1.693A15.11 15.11 0 001.5 12.5c0 3.38 1.106 6.507 2.976 9.029A3.67 3.67 0 007.52 23.5h8.96a3.67 3.67 0 003.044-1.971A15.11 15.11 0 0022.5 12.5c0-3.38-1.106-6.507-2.976-9.029-.93-1.228-2.522-1.875-4.11-1.693a48.491 48.491 0 01-4.163.3.64.64 0 01-.657-.643v0z" />
    </svg>
  ),
  server: (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
