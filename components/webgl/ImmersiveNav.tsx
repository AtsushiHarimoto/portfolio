...
function useNavItems() {
  const { t } = useLocale();
  return [
    { key: 'home', path: '/', label: t.nav.home, icon: '桜', gradient: 'from-[#ffc0d3]/20 to-[#ffc0d3]/5', glowColor: 'rgba(255,192,211,0.4)' },
    { key: 'projects', path: '/projects/', label: t.nav.projects, icon: '構', gradient: 'from-[#e8b4d4]/20 to-[#c096b4]/5', glowColor: 'rgba(232,180,212,0.4)' },
    { key: 'articles', path: '/articles/', label: t.nav.articles, icon: '文', gradient: 'from-[#c096b4]/20 to-[#a78bfa]/5', glowColor: 'rgba(192,150,180,0.4)' },
